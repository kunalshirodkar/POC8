...
import com.poc.service.ProjectService;
import com.poc.service.StudentService;

//@RestController  //turn on while testing
@Controller	
public class StuProController {
	...
	public String viewHomePage(Model model) {
		return findPaginated(1, "firstName", "asc", model);			// calls findPaginated method
	}
	...
	//delete student
	//@DeleteMapping("/deleteStudent/{id}")	//comment while running main app //on while using junit
	...
	//delete project
	//@DeleteMapping("/student/{studentId}/deleteProject/{id}")	//comment while running main app //on while using junit
